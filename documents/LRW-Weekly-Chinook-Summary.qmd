...
```{r}
#| label: table3b-weekly-broodstock-progress
#| echo: false
weekly_progress <- build_weekly_broodstock_progress(grsme_df, trap.year)
render_weekly_broodstock_flextable(weekly_progress)
```
